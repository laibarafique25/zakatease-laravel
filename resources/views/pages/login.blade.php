...
<section class="section" id="login-page">
  <div class="section-header reveal">
    ...
    <h2>Member Login</h2>
    <p class="section-sub">Sign in to manage your profile, donations, and support requests.</p>
  </div>
  <div class="section-inner reveal" style="max-width:520px;margin:0 auto;background:var(--card-bg);border:1px solid var(--border);border-radius:24px;padding:2rem;box-shadow:var(--shadow)">
    ...
    <form method="POST" action="{{ route('login.submit') }}">
      ...
      <input type="password" name="password" placeholder="••••••••" style="width:100%;padding:14px;border:1px solid var(--border);border-radius:14px;margin-bottom:1.5rem;font-size:0.95rem">
      <button class="btn-primary" type="submit" style="width:100%;padding:14px 0;font-size:1rem">Login</button>
    </form>

    <p style="margin-top:1rem;text-align:center;color:var(--text-light)">New here? <a href="{{ route('signup') }}" style="color:var(--emerald);text-decoration:none">Create an account</a></p>
  </div>
</section>
