...
<head>
  ...
  <title>ZARIYAH User Portal</title>
...
<body>
  ...
  <!-- LEFT SIDEBAR -->
  <aside class="admin-sidebar" style="border-right-color: var(--accent-secondary)">
    <a href="{{ url('/') }}" class="sidebar-logo">
      <div class="logo-icon" style="background: var(--accent-secondary)">
      ...
      <span class="logo-text" style="color: var(--accent-secondary)">ZARIYAH</span>
    </a>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="{{ Request::is('my-donations') ? 'active' : '' }}">
        <a href="{{ url('/my-donations') }}">
          <span class="icon">🪙</span> My Donations
        </a>
      </li>
      <li class="{{ Request::is('my-zakat') ? 'active' : '' }}">
        <a href="{{ url('/my-zakat') }}">
          <span class="icon">🧮</span> My Zakat Calculator
        </a>
      </li>
      <li class="{{ Request::is('my-prayers') ? 'active' : '' }}">
        <a href="{{ url('/my-prayers') }}">
          <span class="icon">🕌</span> My Prayers & Streaks
        </a>
      </li>
      <li class="{{ Request::is('my-bookmarks') ? 'active' : '' }}">
    ...
    <header class="admin-navbar">
      ...
      <div class="nav-actions">
        ...
        <div class="user-profile-menu" onclick="toggleProfileDropdown()">
          <div class="profile-avatar" style="border-color: var(--accent-secondary)">
          ...
          <div id="profile-dropdown" style="display:none; position:absolute; right:0; top:50px; background:var(--card); border:1px solid var(--border); border-radius:12px; box-shadow:var(--shadow-lg); width:180px; padding:0.5rem 0; z-index:110">
            <a href="{{ url('/dashboard') }}" style="display:block; padding:0.6rem 1rem; color:var(--text); text-decoration:none; font-size:0.875rem; font-weight:500; transition:background 0.2s">My Dashboard</a>
